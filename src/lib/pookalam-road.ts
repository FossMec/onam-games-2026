...
export const ROAD_STOPS: RoadStop[] = [
  ...
  },
  {
    ...
    hookNamed: "{name}, you leave this stop with an empty file you can draw in.",
    steps: [
  ...
  },
  {
    ...
    hookNamed: "One shape on screen, {name}. Yes, that is today's entire goal.",
    steps: [
...
for (let ring = 0; ring < 4; ring++) {
  ...
  },
  {
    ...
    hookNamed: "An undo button that never expires, {name}.",
    steps: [
  ...
  },
  {
    ...
    hookNamed: "A link you can paste into the form, {name} - and your first open-source repo.",
    steps: [
...
git push -u origin main`,
  ...
  },
  {
    ...
    hookNamed: "Read this now, {name}. Not at 11:50pm on Day 6.",
    steps: [
