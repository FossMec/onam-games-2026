...
export default function CodeAPookalam() {
  ...
  // The whole page renders only after mount. In production, Solid's hydration
  // pass crashes when lucide's `Dynamic`-tagged icons render for markup the
  // server never sent (this route's Suspense resolves mid-hydration), so no
  ...
  return (
    <main class="container space-y-12 py-6">
      ...
      />
      <Meta property="og:title" content={`${POOKALAM.title} - Onam Games`} />
      <Meta
      ...
      <Meta name="twitter:title" content={`${POOKALAM.title} - Onam Games`} />
      <Meta
            ...
            >
              ...
              <div class="w-full space-y-2">
                ...
                <p class="comment text-xs">
                  ...
                  >
                    the jury picked your pookalam for the head-to-head arena. the community votes
                    all day on Day 7 - good luck!
                  </Show>
                </p>
