  ...
  /* ---------------------------------------------------------------- day 6 */
  {
    ...
    public: {
      ...
      howTo: [
        ...
        "Each clue asks for either a 6-character code made only of letters and numbers, or a short answer. Stuck? Ask for more hints in the comments on our Instagram.",
